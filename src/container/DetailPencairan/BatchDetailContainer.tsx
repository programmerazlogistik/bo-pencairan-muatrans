...
const BatchDetailContainer = ({ id }: BatchDetailContainerProps) => {
  ...
  const fields =
    BATCH_DUMMY_DATA[decodedId] || BATCH_DUMMY_DATA["EXP/2026/001"];
  ...
  return (
    <div className="flex flex-col items-start gap-[10px]">
      ...
      <div className="w-full">
        <DataTableBO.Root data={BATCH_TABLE_DATA} columns={batchTableColumns}>
          <DataTableBO.Content />
