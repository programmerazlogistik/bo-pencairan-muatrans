  ...
  "flex h-10 flex-shrink-0 items-center justify-center gap-1 rounded-[24px] py-3 text-sm font-semibold leading-[16.8px] transition-colors md:h-8 md:px-6",
  {
    variants: {
      variant: {
        ...
        "muattrans-error": "bg-error-400 hover:bg-error-600 text-neutral-50",
        "muattrans-error-secondary":
          "border-error-400 text-error-400 hover:bg-error-50 border bg-neutral-50",
        "muattrans-warning":
          "bg-secondary-500 text-primary-700 hover:bg-secondary-300",
        "muatparts-primary":
          "bg-primary-700 hover:bg-primary-800 text-neutral-50",
        "muatparts-primary-secondary":
          "border-primary-700 text-primary-700 hover:bg-primary-50 border bg-neutral-50",
        "muatparts-error": "bg-error-400 hover:bg-error-600 text-neutral-50",
        "muatparts-error-secondary":
          "border-error-400 text-error-400 hover:bg-error-50 border bg-neutral-50",
        "muatparts-warning":
          "bg-secondary-500 text-primary-700 hover:bg-secondary-300",
        link: "text-primary-700 hover:text-primary-800 border-0 bg-transparent p-0 px-0 font-medium no-underline md:h-[14px] md:px-0",
